...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        // ...
        listMhs.add(new Mahasiswa("2102665", "Muhammad Cahyana Bintang Fajar", "A","C1","Laki-Laki"));
//        listMhs.add(new Mahasiswa("2102667", "Audry Leonardo", "A"));
//        listMhs.add(new Mahasiswa("2102668", "Yogi Harga", "A"));
    ...
    public final DefaultTableModel setTable() {
        // Column Title
        // ...
        Object[] column={"NIM","Nama","Nilai","Kelas","Jenis Kelamin"};
    ...
    public void insertData() {
        ...
        if(fieldLK.isSelected()){
            jk=fieldLK.getText();
            listMhs.add(new Mahasiswa(nim,nama,nilai,kelas,jk));
             System.out.println("Insert Success");
        JOptionPane.showMessageDialog(null, "Data berhasil ditambahkan");
        }
        else if(fieldPR.isSelected()){
            jk=fieldPR.getText();
            listMhs.add(new Mahasiswa(nim,nama,nilai,kelas,jk));
             System.out.println("Insert Success");
        JOptionPane.showMessageDialog(null, "Data berhasil ditambahkan");
                ...
                JOptionPane.showMessageDialog(null, "Jenis Kelamin Tidak Boleh Kosong,data gagal ditambahkan");
               }
    ...
    public void updateData() {
        ...
        JOptionPane.showMessageDialog(null, "Data Berhasil Diubah");
                ...
                JOptionPane.showMessageDialog(null, "Jenis Kelamin Tidak Boleh Kosong, data gagal di update");
            }
    ...
    public void deleteData() {
        ...
        // ...
        int opsi = JOptionPane.showConfirmDialog(null, "Apakah Anda Yakin ingin menghapusnya?","Delete",JOptionPane.YES_NO_OPTION);
       if (opsi==0){
    ...
    private void initComponents() {
        ...
        fieldLK = new javax.swing.JCheckBox();
        fieldPR = new javax.swing.JCheckBox();
        ...
        fieldKelas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fieldKelasActionPerformed(evt);
            }
        });
        ...
        buttonGroup1.add(fieldLK);
        fieldLK.setText("Laki-Laki");
        fieldLK.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fieldLKActionPerformed(evt);
            }
        });

        buttonGroup1.add(fieldPR);
        fieldPR.setText("Perempuan");
        fieldPR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fieldPRActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(6, 6, 6)
                                        .addComponent(fieldLK, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(8, 8, 8)
                                        .addComponent(fieldPR, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(fieldNilai, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(fieldKelas, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblNilai1)
                    .addComponent(fieldKelas, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblNilai2)
                    .addComponent(fieldLK)
                    .addComponent(fieldPR))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void fieldKelasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fieldKelasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fieldKelasActionPerformed

    private void fieldLKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fieldLKActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fieldLKActionPerformed

    private void fieldPRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fieldPRActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fieldPRActionPerformed
